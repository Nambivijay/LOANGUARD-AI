...
const LoanRequestModal = ({ isOpen, onClose, onRefresh }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('http://127.0.0.1:5001/api/loans',
                { amount, purpose },
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, backdropFilter: 'blur(4px)' }}>
            <div className="card glass" style={{ width: '100%', maxWidth: '450px', position: 'relative' }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <button type="submit" className="btn-primary" style={{ justifyContent: 'center', marginTop: '1rem' }}>Submit Application</button>
                </form>
            </div>
        </div>
    );
